          ...
          <div className="lg:col-span-1 bg-gray-50 p-4 rounded-xl border border-gray-200 flex flex-col justify-between shadow-sm">
            <div>
              ...
              <p className="text-[12px] text-gray-600 mb-4 leading-relaxed">
                Muestra dónde está lloviendo ahora mismo y hacia dónde se mueven
                las tormentas. Usalo para ver rápido si una zona está siendo
                afectada.
              </p>
              <ul className="text-[12px] text-gray-500 space-y-3">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong>Colores:</strong> Indican qué tan fuerte llueve. Si
                    ves amarillo o rojo, es tormenta fuerte.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-blue-500 font-bold">•</span>
                  <span>
                    <strong>Evolución:</strong> Tocá la línea de tiempo abajo
                    para ver el pronóstico de las próximas horas.
                  </span>
                </li>
              </ul>
            </div>
        ...
        {isRiesgoOpen && (
          <div className="p-4 border-t border-gray-200 bg-white grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded-xl border border-gray-200 p-6 flex flex-col justify-between shadow-sm min-h-[220px]">
              <div>
                ...
                <p className="text-[12px] text-gray-600 leading-relaxed mb-2">
                  <strong>Qué vas a encontrar:</strong> Un mapa global que marca
                  específicamente las zonas con peligro de inundación.
                </p>
            ...
            <div className="bg-gray-50 rounded-xl border border-gray-200 p-6 flex flex-col justify-between shadow-sm min-h-[220px]">
              <div>
                <h4 className="text-sm font-bold text-gray-800 mb-2">
                  Niveles de Ríos (Prefectura)
                </h4>
                <p className="text-[12px] text-gray-600 leading-relaxed mb-2">
                  <strong>Qué vas a encontrar:</strong> El mapa interactivo
                  oficial con las mediciones reales de todos los puertos del
                  país.
                </p>
                <p className="text-[12px] text-gray-600 leading-relaxed">
